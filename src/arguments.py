...
def parse_args():
    ...
    # secant
    parser.add_argument('--secant_resume_expert', default=None, type=str)
    parser.add_argument('--secant_lr', default=1e-3, type=float)
    parser.add_argument('--secant_buffer_size', default=50000, type=int)
    parser.add_argument('--secant_train_steps', default=50000, type=int)
    parser.add_argument('--secant_save_freq', default=10000, type=int)
    ...
    assert args.algorithm in {
        'sac', 'rad', 'curl', 'pad', 'soda', 'drq', 'svea', 'secant'
    ...
    if args.algorithm in {'rad', 'curl', 'pad', 'soda', 'secant'}:
        args.image_size = 100
